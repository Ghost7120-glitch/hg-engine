...
.equ TRAINERCLASS_CHAMPION_STEVEN,        129
.equ TRAINERCLASS_CHAMPION_WALLACE,       130
.equ TRAINERCLASS_ELITE_FOUR_SIDNEY,      131
.equ TRAINERCLASS_ELITE_FOUR_PHOEBE,      132
.equ TRAINERCLASS_ELITE_FOUR_GLACIA,      133
.equ TRAINERCLASS_ELITE_FOUR_DRAKE,       134
.equ TRAINERCLASS_LEADER_ROXANNE,         135
.equ TRAINERCLASS_LEADER_BRAWLY,          136
.equ TRAINERCLASS_LEADER_WATTSON,         137
.equ TRAINERCLASS_LEADER_FLANNERY,        138
.equ TRAINERCLASS_LEADER_NORMAN,          139
.equ TRAINERCLASS_LEADER_WINONA,          140
.equ TRAINERCLASS_LEADER_LIZA,            141
.equ TRAINERCLASS_LEADER_TATE,            142
.equ TRAINERCLASS_LEADER_JUAN,            143
.equ TRAINERCLASS_CHAMPION_CYNTHIA,       144
.equ TRAINERCLASS_SPECIAL_AGENT,          145
.equ TRAINERCLASS_ELITE_FOUR_AARON,       146
.equ TRAINERCLASS_ELITE_FOUR_BERTHA,      147
.equ TRAINERCLASS_ELITE_FOUR_FLINT,       148
.equ TRAINERCLASS_ELITE_FOUR_LUCIAN,      149
.equ TRAINERCLASS_LEADER_ROARK,           150
.equ TRAINERCLASS_LEADER_GARDENIA,        151
.equ TRAINERCLASS_LEADER_MAYLENE,         152
.equ TRAINERCLASS_LEADER_CRASHER_WAKE,    153
.equ TRAINERCLASS_LEADER_FANTINA,         154
.equ TRAINERCLASS_LEADER_BYRON,           155
.equ TRAINERCLASS_LEADER_CANDICE,         156
.equ TRAINERCLASS_LEADER_VOLKNER,         157
.equ TRAINERCLASS_PKMN_TRAINER_GREEN,     158
.equ TRAINERCLASS_UNOVAN_PRODIGY_LOGAN,   159
.equ TRAINERCLASS_ELITE_FOUR_RIKA,        160
.equ TRAINERCLASS_PKMN_TRAINER_KRIS,      161
.equ TRAINERCLASS_PKMN_TRAINER_BRENDAN,   162
.equ TRAINERCLASS_PKMN_TRAINER_MAY,       163
.equ TRAINERCLASS_PKMN_TRAINER_WALLY,     164
.equ TRAINERCLASS_PKMN_TRAINER_BARRY,     165
.equ TRAINERCLASS_FACTORY_DIRECTOR,       166
.equ TRAINERCLASS_ARENA_TYCOON,           167
.equ TRAINERCLASS_DOME_ACE,               168
.equ TRAINERCLASS_PIKE_QUEEN,             169
.equ TRAINERCLASS_PALACE_MAVEN,           170
.equ TRAINERCLASS_PYRAMID_KING,           171
.equ TRAINERCLASS_SALON_MAIDEN,           172
.equ TRAINERCLASS_ADMIN_MATT,             173
.equ TRAINERCLASS_ADMIN_SHELLY,           174
.equ TRAINERCLASS_AQUA_LEADER,            175
.equ TRAINERCLASS_ADMIN_TABITHA,          176
.equ TRAINERCLASS_ADMIN_COURTNEY,         177
.equ TRAINERCLASS_MAGMA_LEADER,           178
.equ TRAINERCLASS_COMMANDER_MARS,         179
.equ TRAINERCLASS_COMMANDER_JUPITER,      180
.equ TRAINERCLASS_COMMANDER_SATURN,       181
.equ TRAINERCLASS_COMMANDER_CHARON,       182
.equ TRAINERCLASS_GALACTIC_BOSS,          183
.equ TRAINERCLASS_CASTLE_LADY,            184
.equ TRAINERCLASS_PKMN_TRAINER_ELIO,      185
.equ TRAINERCLASS_PKMN_LEGEND_BLUE,       186
.equ TRAINERCLASS_PKMN_LEGEND_LEAF,       187
.equ TRAINERCLASS_ARC_CHAMPION_LANCE,     188
.equ TRAINERCLASS_HOENN_CHAMPION_MAY,     189
.equ TRAINERCLASS_PKMN_LEGEND_RED,        190
.equ TRAINERCLASS_PKMN_TRAINER_TOBIAS,    191
.equ TRAINERCLASS_CHAMPION_ALDER,         192
.equ TRAINERCLASS_CHAMPION_ALAIN,         193
.equ TRAINERCLASS_KALOS_ASH,              194
.equ TRAINERCLASS_LEADER_CILAN,           195
.equ TRAINERCLASS_LEADER_CRESS,           196
.equ TRAINERCLASS_LEADER_CHILI,           197
.equ TRAINERCLASS_LEADER_LENORA,          198
.equ TRAINERCLASS_LEADER_BURGH,           199
.equ TRAINERCLASS_LEADER_ELESA,           200
.equ TRAINERCLASS_LEADER_CLAY,            201
.equ TRAINERCLASS_LEADER_SKYLA,           202
.equ TRAINERCLASS_LEADER_BRYCEN,          203
.equ TRAINERCLASS_PKMN_TRAINER_IRIS,      204
.equ TRAINERCLASS_CHAMPION_IRIS,          205
.equ TRAINERCLASS_LEADER_DRAYDEN,         206
.equ TRAINERCLASS_LEADER_MARLON,          207
.equ TRAINERCLASS_ELITE_FOUR_MARSHAL,     208
.equ TRAINERCLASS_ELITE_FOUR_GRIMSLEY,    209
.equ TRAINERCLASS_ELITE_FOUR_SHAUNTAL,    210
.equ TRAINERCLASS_LEADER_ROXIE,           211
.equ TRAINERCLASS_LEADER_CHEREN,          212
.equ TRAINERCLASS_DISTANT_TRAVELLER_KYLE, 213
.equ TRAINERCLASS_PLASMA_BOSS,            214
.equ TRAINERCLASS_PLASMA_LEADER,          215
.equ TRAINERCLASS_PLASMA_KING,            216
.equ TRAINERCLASS_TRAINER_NATE,           217
.equ TRAINERCLASS_TRAINER_HILDA,          218
.equ TRAINERCLASS_TRAINER_HILBERT,        219
.equ TRAINERCLASS_TRAINER_ROSA,           220
.equ TRAINERCLASS_TRAINER_BIANCA,         221
.equ TRAINERCLASS_PKMN_TRAINER_NEMONA,    222
.equ TRAINERCLASS_TRAINER_BENGA,          223
.equ TRAINERCLASS_ELITE_FOUR_AGATHA,      224
.equ TRAINERCLASS_LEADER_VIOLA,           225
.equ TRAINERCLASS_LEADER_GRANT,           226
.equ TRAINERCLASS_LEADER_KORRINA,         227
.equ TRAINERCLASS_LEADER_RAMOS,           228
.equ TRAINERCLASS_LEADER_CLEMONT,         229
.equ TRAINERCLASS_LEADER_VALERIE,         230
.equ TRAINERCLASS_LEADER_OLYMPIA,         231
.equ TRAINERCLASS_LEADER_WULFRIC,         232
.equ TRAINERCLASS_ELITE_FOUR_MALVA,       233
.equ TRAINERCLASS_ELITE_FOUR_SIEBOLD,     234
.equ TRAINERCLASS_ELITE_FOUR_WIKSTROM,    235
.equ TRAINERCLASS_ELITE_FOUR_DRASNA,      236
.equ TRAINERCLASS_FLARE_BOSS,             237
.equ TRAINERCLASS_GALAR_CHAMPION_LEON,    238
.equ TRAINERCLASS_TRAINER_SERENA,         239
.equ TRAINERCLASS_TRAINER_CALEM,          240
.equ TRAINERCLASS_CHAMPION_DIANTHA,       241
.equ TRAINERCLASS_PKMN_TRAINER_LEAF,      242
.equ TRAINERCLASS_FRIEND_TIERNO,          243
.equ TRAINERCLASS_FRIEND_TREVOR,          244
.equ TRAINERCLASS_FRIEND_SHAUNA,          245
.equ TRAINERCLASS_SHADOW_TRIAD,           246
.equ TRAINERCLASS_ELITE_FOUR_LARRY,       247
.equ TRAINERCLASS_ELITE_FOUR_LORELEI,     248
.equ TRAINERCLASS_DRAGON_MASTER_COREY,    249
.equ TRAINERCLASS_FUTURE_LEGEND_KYLE,     250
.equ TRAINERCLASS_NEXON_CHAMPION_UMARA,   251
.equ TRAINERCLASS_PLASMA_COLRESS,         252
.equ TRAINERCLASS_SUBWAY_BOSS_EMMET,      253
.equ TRAINERCLASS_SUBWAY_BOSS_INGO,       254
.equ TRAINERCLASS_ELITE_FOUR_DRAYTON,     255
