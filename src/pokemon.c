...
const u8 sTrainerGenders[] = {
    ...
    [TRAINERCLASS_STAT_TRAINER_CHERYL] = TRAINER_FEMALE,
    [TRAINERCLASS_STAT_TRAINER_MARLEY] = TRAINER_FEMALE,
    [TRAINERCLASS_STAT_TRAINER_MIRA] = TRAINER_FEMALE,
    [TRAINERCLASS_STAT_TRAINER_RILEY] = TRAINER_MALE,
    [TRAINERCLASS_EVIL_TRAINER_VOLO] = TRAINER_MALE,
    ...
    [TRAINERCLASS_ELITE_FOUR_LACEY] = TRAINER_FEMALE,
    ...
    [TRAINERCLASS_ELITE_FOUR_AMARYS] = TRAINER_FEMALE,
    ...
    [TRAINERCLASS_ELITE_FOUR_CRISPIN] = TRAINER_MALE,
    ...
    [TRAINERCLASS_FLARE_ADMIN] = TRAINER_MALE,
    ...
    [TRAINERCLASS_ROCKET_JESSIE_JAMES] = TRAINER_MALE, // Assuming James is the primary gender
    ...
    [TRAINERCLASS_ELITE_FOUR_HASSEL] = TRAINER_MALE,
    ...
    [TRAINERCLASS_RIVAL_PAUL] = TRAINER_MALE,
    [TRAINERCLASS_CRESCENT] = TRAINER_MALE,
    [TRAINERCLASS_NERD_CONWAY] = TRAINER_MALE,
};
